...
Begin VB.Form rptSalesLedgerReport1 
   Caption         =   "Duty and Cess Details"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   ...
   EndProperty
   Icon            =   "SalesLedgerReport1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame frastep 
      ...
      Begin VB.ComboBox cmbType 
         Height          =   330
         ItemData        =   "SalesLedgerReport1.frx":000C
         Left            =   90
         List            =   "SalesLedgerReport1.frx":002E
   ...
   Begin VB.Frame FraReportType 
      ...
      Begin VB.ComboBox cmbReportType 
         Height          =   330
         ItemData        =   "SalesLedgerReport1.frx":0093
         Left            =   90
         List            =   "SalesLedgerReport1.frx":009D
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   210
         Width           =   2430
...
Begin AceSpread spList
   ...
   End
End
Attribute VB_Name = "rptSalesLedgerReport1"
...
frmPrint.sprPrint.Row = j
    ...
    frmPrint.sprPrint.SetText frmPrint.sprPrint.Col, j, "Duty and Cess Report between " & dpfromdt & " and " & dptodt
frmPrint.sprPrint.TypeHAlign = TypeHAlignCenter
frmPrint.sprPrint.Font = "Arial"
frmPrint.sprPrint.FontBold = True
...
frmPrint.sprPrint.Row = j
    ...
    frmPrint.sprPrint.SetText frmPrint.sprPrint.Col, j, "InvoiceDate"
...
frmPrint.sprPrint.Row = j
    ...
    '.SetText .Col, j, "Cess 2%": .ColWidth(.Col) = 8: .TypeVAlign = TypeVAlignCenter: .TypeHAlign = TypeHAlignRight: .Font = "Arial": .FontBold = True
...
frmPrint.sprPrint.Row = j
    ...
    '.SetText .Col, j, "Cess 1%": .ColWidth(.Col) = 10: .TypeVAlign = TypeVAlignCenter: .TypeHAlign = TypeHAlignRight: .Font = "Arial": .FontBold = True

    frmPrint.sprPrint.SetText frmPrint.sprPrint.Col, j, "SHE Cess"
frmPrint.sprPrint.ColWidth(frmPrint.sprPrint.Col) = 10
frmPrint.sprPrint.TypeVAlign = TypeVAlignCenter
frmPrint.sprPrint.TypeHAlign = TypeHAlignRight
frmPrint.sprPrint.Font = "Arial"
...
frmPrint.sprPrint.FontBold = True
    ...
    '.SetText .Col, j, "Total": .ColWidth(.Col) = 10: .TypeVAlign = TypeVAlignCenter: .TypeHAlign = TypeHAlignRight: .Font = "Arial": .FontBold = True
...
frmPrint.sprPrint.FontBold = True
   ...
   ' .Col = 6: .Row = j
    ...
    '.SetText .Col, j, "Total": .TypeVAlign = TypeVAlignCenter: .TypeHAlign = TypeHAlignRight: .Font = "Arial": .FontBold = True
...
spList.Col = 1
  ...
  End If
 ' If cmbType <> "All" Then
 '   sql = sql + " and type = '" & cmbType & " '"
 ' End If
  Sql = Sql + " and type in('OE','Scrap','Rejection','supplementary','Miscellaneous')"
  Sql = Sql + " and a.Branchid='" & gBranchID & "' and a.Compid = '" & gCompID & "'" 'and a.Finyear = '" & gFinyear & "'"
  Sql = Sql + " group By a.InvoiceType, a.Invoiceno, A.Invoicedate,a.ItemCode,c.ItemDescription, a.CustomerCode order by a.Invoiceno"
...
frmPrint.sprPrint.FontBold = False
                 tot(0) = Val(tot(0)) + Val(rs("Resultvalue"))
                 
              Case "S&H EDU.CESS 1%", "S&H EDU CESS 1%"
...
frmPrint.sprPrint.FontBold = False
              ...
              Case "EXCISE DUTY  8%", "EXCISE DUTY 10%", "EXCISE DUTY 12%", "EXCISE DUTY @ 12.5%", "CENVAT CLAIMS"
...
'            If Trim$(rs("Exprname")) = "CESS 2%" Then
'              Spread_Set_CellBorder frmPrint.sprPrint, CellBorderIndexLeft, 5, j, 5, j
'              .Col = 5: .Row = j
'             ' .GetText .Col, j, tmp
'              .SetText .Col, j, Format(rs("Resultvalue"), "0.00"): .TypeVAlign = TypeVAlignCenter: .TypeHAlign = TypeHAlignRight: .Font = "Arial": .FontBold = False
'              tot(0) = Val(tot(0)) + Val(rs("Resultvalue"))
'            ElseIf Trim$(rs("Exprname")) = "S&H EDU.CESS 1%" Or Trim$(rs("Exprname")) = "S&H EDU CESS 1%" Then
'              Spread_Set_CellBorder frmPrint.sprPrint, CellBorderIndexLeft, 6, j, 6, j
'              .Col = 6: .Row = j

'              .SetText .Col, j, Format(rs("Resultvalue"), "0.00"): .TypeVAlign = TypeVAlignCenter: .TypeHAlign = TypeHAlignRight: .Font = "Arial": .FontBold = False
'              tot(4) = Val(tot(4)) + Val(rs("Resultvalue"))
'            ElseIf Trim$(rs("Exprname")) = "EXCISE DUTY  8%" Or Trim$(rs("Exprname")) = "EXCISE DUTY 10%" Or Trim$(rs("Exprname")) = "EXCISE DUTY 12%" Or Trim$(rs("Exprname")) = "CENVAT CLAIMS" Then
'              Spread_Set_CellBorder frmPrint.sprPrint, CellBorderIndexLeft, 4, j, 4, j
'              .Col = 4: .Row = j
...
GridCount = GridCount + 1
        ...
        If GridCount = 54 Then
          gvtot = gvtot + subtotgv
          edtot = edtot + subtoted
          cess2 = cess2 + subtotcess
          cess1 = cess1 + subtotscess
          cess3 = cess1 + cess2 + edtot
          
          subtot1(L) = Format(subtotgv, "0.00")
          ...
          frmPrint.sprPrint.SetText 3, j, Format(subtotgv, "0.00")
frmPrint.sprPrint.TypeVAlign = TypeVAlignCenter
frmPrint.sprPrint.TypeHAlign = TypeHAlignRight
frmPrint.sprPrint.FontBold = True
          Spread_Set_CellBorder frmPrint.sprPrint, CellBorderIndexLeft, 4, j, 4, j
          ...
          frmPrint.sprPrint.SetText 4, j, Format(subtoted, "0.00")
frmPrint.sprPrint.TypeVAlign = TypeVAlignCenter
frmPrint.sprPrint.TypeHAlign = TypeHAlignRight
frmPrint.sprPrint.FontBold = True
          Spread_Set_CellBorder frmPrint.sprPrint, CellBorderIndexLeft, 5, j, 5, j
          ...
          frmPrint.sprPrint.SetText 5, j, Format(subtotcess, "0.00")
frmPrint.sprPrint.TypeVAlign = TypeVAlignCenter
frmPrint.sprPrint.TypeHAlign = TypeHAlignRight
frmPrint.sprPrint.FontBold = True
          Spread_Set_CellBorder frmPrint.sprPrint, CellBorderIndexLeft, 6, j, 6, j
          ...
          frmPrint.sprPrint.SetText 6, j, Format(subtotscess, "0.00")
frmPrint.sprPrint.TypeVAlign = TypeVAlignCenter
frmPrint.sprPrint.TypeHAlign = TypeHAlignRight
frmPrint.sprPrint.FontBold = True
          ...
          frmPrint.sprPrint.SetText 7, j, Format(subtot, "0.00")
frmPrint.sprPrint.TypeVAlign = TypeVAlignCenter
frmPrint.sprPrint.TypeHAlign = TypeHAlignRight
frmPrint.sprPrint.FontBold = True
          L = L + 1
...
frmPrint.sprPrint.FontBold = True
      ...
      subtot11(1) = Format(subtotgv, "0.00")
...
frmPrint.sprPrint.FontBold = True
       j = j + 1
      Spread_Set_CellBorder frmPrint.sprPrint, CellBorderIndexOutline, 2, j + 1, frmPrint.sprPrint.MaxCols, j + 1
      frmPrint.sprPrint.SetText 1, j + 1, "PageNo" & Space(9) & "ASS.VALUE" & Space(8) & "Excise Duty" & Space(8) & "CESS" & Space(8) & "SHE CESS" & Space(6) & "Total Amount"
frmPrint.sprPrint.FontBold = True
      
      For i = 1 To L
       Spread_Set_CellBorder frmPrint.sprPrint, CellBorderIndexOutline, 1, j + i, frmPrint.sprPrint.MaxCols, j + i
       frmPrint.sprPrint.SetText 1, j + i + 1, "PageNo" & (i)
       frmPrint.sprPrint.SetText 2, j + i + 1, subtot1(i)
      ...
      Next i
      Spread_Set_CellBorder frmPrint.sprPrint, CellBorderIndexOutline, 2, j + i, frmPrint.sprPrint.MaxCols, j + i
      frmPrint.sprPrint.SetText 2, j + i, subtot11(1)
      ...
      Spread_Set_CellBorder frmPrint.sprPrint, CellBorderIndexOutline, 1, j + i + 1, frmPrint.sprPrint.MaxCols, j + i + 1
      frmPrint.sprPrint.SetText 1, j + i + 1, "Total"
      frmPrint.sprPrint.SetText 2, j + i + 1, subtot31(1)
...
Private Sub InitializeSpreads()
	...
	Call Design_spList("D:\OutOfSync\_2_UnicornERP_Convertion_VB6ToNextJS_Antigravity\Export_VB6_Sales\PrePost_Sales\Sales\Sales\SalesLedgerReport1.frm", spList, "")
