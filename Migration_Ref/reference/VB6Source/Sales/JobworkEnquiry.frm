...
Begin VB.Form frmJobworkEnquiry 
   Caption         =   "Jobwork Enquiry"
   ClientHeight    =   3915
   ClientLeft      =   240
   ClientTop       =   1545
   ClientWidth     =   6585
...
Begin AceSpread sprRecd
   ...
   Begin VB.Frame FraEnq 
      ...
      Begin VB.ComboBox cmbCustomerType 
         Height          =   330
         ItemData        =   "JobworkEnquiry.frx":0614
         Left            =   5805
         List            =   "JobworkEnquiry.frx":061E
...
Begin AceSpread sprItem
   ...
   End
End
Attribute VB_Name = "frmJobworkEnquiry"
...
sRow = Val(sprItem.Text)
      ...
      sprItem.Row = sRow
sprItem.Col = eItem.mTarDate
      If Val(sprItem.Text) = 0 Then
        sShowMessage "Select the TargetDate"
        Spread_Set_Focus sprItem, sRow, eItem.mTarDate
        Chkbefsave = False
        GoTo ExitHere
      End If
...
Private Sub SetDocNo()
  ...
  txtEnqNo = GetDocNo("SAL_JOBWORKENQUIRY_HDR", "EnquiryType", "EnquiryNo", Trim$(cmbEnqType), "N")
Catch ex As Exception
  Call ErrMsgShow(ex)
...
Private Sub cmdSave_Click()
  Dim retVal As Variant
'  Dim enqnorec As ADODB.Recordset
...
'  Set enqnorec = New ADODB.Recordset
...
End If
  ...
  sShowMessage "Jobwork Enquiry Number :" & Trim$(cmbEnqType) & Trim$(txtEnqNo) & "  Is Generated"
  CmdClear_Click
Catch ex As Exception
  Call ErrMsgShow(ex)
...
Private Sub InitializeSpreads()
	...
	Call Design_sprSent("D:\OutOfSync\_2_UnicornERP_Convertion_VB6ToNextJS_Antigravity\Export_VB6_Sales\PrePost_Sales\Sales\Sales\JobworkEnquiry.frm", sprSent, "")

	Call Design_sprRecd("D:\OutOfSync\_2_UnicornERP_Convertion_VB6ToNextJS_Antigravity\Export_VB6_Sales\PrePost_Sales\Sales\Sales\JobworkEnquiry.frm", sprRecd, "")

	Call Design_sprItem("D:\OutOfSync\_2_UnicornERP_Convertion_VB6ToNextJS_Antigravity\Export_VB6_Sales\PrePost_Sales\Sales\Sales\JobworkEnquiry.frm", sprItem, "")
