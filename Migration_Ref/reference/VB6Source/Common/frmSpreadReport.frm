...
Begin VB.Form frmSpreadReport 
   ...
   Begin VB.CommandButton cmdExit 
      ...
      Height          =   675
      Left            =   8505
      Picture         =   "frmSpreadReport.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   10
      Top             =   0
      Width           =   960
   ...
   Begin VB.CommandButton cmdDOS 
      ...
      Height          =   675
      Left            =   7560
      Picture         =   "frmSpreadReport.frx":04F2
      Style           =   1  'Graphical
      TabIndex        =   9
      Top             =   0
      Width           =   960
   ...
   Begin VB.CommandButton cmdExcel 
      ...
      Height          =   675
      Left            =   6615
      Picture         =   "frmSpreadReport.frx":0B5C
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   0
      Width           =   960
   ...
   Begin VB.CommandButton cmdText 
      ...
      Height          =   675
      Left            =   5670
      Picture         =   "frmSpreadReport.frx":0C5E
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   0
      Width           =   960
   ...
   Begin VB.CommandButton cmdDoc 
      ...
      Height          =   675
      Left            =   4725
      Picture         =   "frmSpreadReport.frx":0D60
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   0
      Width           =   960
   ...
   Begin VB.CommandButton cmdSprint 
      ...
      Height          =   675
      Left            =   3780
      Picture         =   "frmSpreadReport.frx":0EEA
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   0
      Width           =   960
   ...
   Begin VB.CommandButton cmdPPrint 
      ...
      Height          =   675
      Left            =   2835
      Picture         =   "frmSpreadReport.frx":1554
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   0
      Width           =   960
   ...
   Begin VB.CommandButton cmdSaveAs 
      ...
      Height          =   675
      Left            =   1890
      Picture         =   "frmSpreadReport.frx":1656
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   0
      Width           =   960
   ...
   Begin VB.CommandButton cmdSave 
      ...
      Height          =   675
      Left            =   945
      Picture         =   "frmSpreadReport.frx":1B58
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   0
      Width           =   960
   ...
   Begin VB.CommandButton cmdOpen 
      ...
      Height          =   675
      Left            =   0
      Picture         =   "frmSpreadReport.frx":1CA6
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   0
      Width           =   960
...
Begin AceSpread sprPrint
   ...
   End
End
Attribute VB_Name = "frmSpreadReport"
...
Private Sub InitializeSpreads()
	...
	Call Design_sprPrint("D:\OutOfSync\_2_UnicornERP_Convertion_VB6ToNextJS_Antigravity\Export_VB6_Sales\PrePost_Sales\Sales\Common\frmSpreadReport.frm", sprPrint, "")
